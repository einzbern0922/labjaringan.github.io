				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								...
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Leader</option>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control form-control-sm" name="email" required value="<?php echo isset($email) ? $email : '' ?>">
							<small id="#msg"></small>
						</div>
						<div class="form-group">
